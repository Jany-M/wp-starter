<?php
    ...
    $args = array(
        ...
        'update_notice' => TRUE,
        'intro_text' => 'Through these options you can manage how your theme behaves, what libraries and style to load, debug mode, more security and more.',
        'footer_text' => '<a href="https://github.com/Jany-M/wp-starter" target="_blank">WP Starter</a> is developed by <a href="http://www.shambix.com" target="_blank">Shambix</a>',
        'menu_type' => 'menu',
